...
import { PurchaseProductController } from "./controllers/purchases_products";
import { PurchaseProductMiddleware } from "./middlewares/purchases_products.middleware";
export class PurchaseProductRouter extends BaseRoute<
